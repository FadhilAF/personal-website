  ...
  return (
    <div
      className={`${styles.header} ${
        ["/", "/login"].includes(props.path) && styles["home-header"]
      } ${hide && !isNavOpen && styles["hide-header"]}`}
    >
        ...
        <div className={styles["navbar-content"]}>
          ...
          <div className={styles["non-logo"]}>
            <HeaderLinks
              pages={pages}
              isPhone={isPhone}
              navState={{ isNavOpen, setIsNavOpen }}
            />
      ...
      {isPhone &&
        dropdownTransition(
          (
            style,
            item //item itu gek diisi isNavOpen, style itu diisi oleh from enter leave
          ) =>
            item ? (
