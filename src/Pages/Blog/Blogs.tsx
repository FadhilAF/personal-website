  ...
  return (
    <div className="text-center">
      ...
      <div className="m-auto title-desc">
        This is the place where I wanted to share something. Maybe like some
        topics or my school assignment that I proud of. And person with
        authentication could post a blog here too.
      </div>
