    ...
    return (
        <div>
            ...
            <div className="topics">
                ...
                <div className={`topic-container ${((topics.length)%2==0)? 'topic-container-odd':'topic-container-even'}`}>
                    {((topics.length)%2==0)? <svg className="separator-odd" viewBox="0 0 900 100" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"><path d="M0 48L75 72L150 38L225 38L300 51L375 47L450 22L525 71L600 49L675 66L750 68L825 20L900 59L900 101L825 101L750 101L675 101L600 101L525 101L450 101L375 101L300 101L225 101L150 101L75 101L0 101Z"></path></svg> :
                    <svg className="separator-even" viewBox="0 0 900 100" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"><path d="M0 77L75 25L150 48L225 32L300 70L375 70L450 27L525 58L600 52L675 76L750 56L825 59L900 56L900 101L825 101L750 101L675 101L600 101L525 101L450 101L375 101L300 101L225 101L150 101L75 101L0 101Z"></path></svg> }
                </div> 
            </div>
        </div>
